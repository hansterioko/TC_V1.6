...
class DeleteShopDialog (private var shopId: Int, private var root: ViewGroup): DialogFragment() {

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return AlertDialog.Builder(activity)
            .setTitle("Удаление магазина")
            .setMessage("Вы подтверждаете удаление этого магазина?")
                ...
                setOnShowListener {
                    ...
                    positiveButton.setOnClickListener {
                        ...
                        lifecycleScope.launch(Dispatchers.IO) {
                            try{
                                val messageResponse = ShopRepository().delete(shopId)
                                if(messageResponse != null){
                                    ...
                                    if(messageResponse.code == 500 || messageResponse.code == 404){
                                        ...
                                        messages.showSuccess("Магазин успешно удалён!",root)
                                ...
                                messages.showError("Ошибка удаления магазина. Повторите попытку", root)
